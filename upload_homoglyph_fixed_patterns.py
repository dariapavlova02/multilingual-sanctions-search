#!/usr/bin/env python3
"""
Upload homoglyph-fixed 26K entities AC patterns to Elasticsearch
"""
...
def upload_patterns_bulk(patterns, batch_size=500):
    ...
    print(f"📤 Uploading {total_patterns:,} homoglyph-fixed patterns in batches of {batch_size}...")
...
def main():
    print("🚀 Starting upload of homoglyph-fixed 26K entities AC patterns...")
    print("=" * 60)

    # Load patterns from file
    patterns_file = "patterns_all_26k_homoglyph_fixed.json"
    ...
    print(f"✅ Loaded {len(patterns):,} homoglyph-fixed patterns")
    print(f"📊 Statistics:")
    ...
    if uploaded_count == len(patterns):
        print("🎉 All homoglyph-fixed patterns uploaded successfully!")
        return 0
    else:
