#!/usr/bin/env python3
"""
Упрощенная демонстрация MorphologyAdapter.

Показывает основные возможности нового адаптера без зависимостей от NormalizationService.
"""
...
def demo_case_preservation():
    """Демонстрация сохранения регистра."""
    print("\n=== Демонстрация сохранения регистра ===")
    ...
    print("Сохранение регистра при конвертации в номинатив:")
    for token, lang in test_cases:
        nominative = adapter.to_nominative(token, lang)
        print(f"  {token} -> {nominative}")
