...
Removes dates/IDs by default, keeps only names/titles for vector generation
"""
...
class EmbeddingPreprocessor:
    ...
    def normalize_for_embedding(self, text: str, *, fold_spaces: bool = True, include_attrs: bool = False) -> str:
        """
        ...
        if include_attrs:
            self.logger.warning("include_attrs=True not yet implemented, using default behavior")
        ...
        self.logger.debug(f"Normalized '{text}' -> '{normalized}' (include_attrs={include_attrs})")
