...
class PatternService:
    ...
    def generate_patterns(self, text: str, language: str = "auto") -> List[NamePattern]:
        """
        ...
        self.logger.info(
            f"Generated {len(unique_patterns)} unique patterns for language: {language}"
        )
    ...
    def _extract_basic_name_patterns(
    ...
    def _extract_payment_context_patterns(
        self, text: str, language: str
    ) -> List[NamePattern]:
    ...
    def _extract_dictionary_name_patterns(
        self, text: str, language: str
    ) -> List[NamePattern]:
