...
STOPWORDS_RU = {
    ...
    # Transport context
    'транспорт', 'транспортный', 'транспортная', 'транспортной', 'пополнение', 'карта', 'карты', 'проезд', 'поездка', 'поездку', 'маршрут', 'автобус', 'троллейбус', 'метро', 'электричка', 'билет', 'билеты', 'проездной'
}
...
STOPWORDS_UK = {
    ...
    # Transport context
    'транспорт', 'транспортна', 'транспортної', 'поповнення', 'карта', 'карти', 'картки', 'проїзд', 'поїздка', 'поїздку', 'маршрут', 'маршрути', 'автобус', 'автобуси', 'тролейбус', 'метро', 'електричка', 'квиток', 'квитки', 'проїзний'
}
