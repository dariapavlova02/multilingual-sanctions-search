...
STOPWORDS_RU = {
    ...
    'оплата', 'платеж', 'пользу', 'услуги', 'товары', 'работы', 'поставка', 'договор', 'контракт', 'счет', 'инвойс', 'основании', 'согласно', 'назначение', 'платежа'
}
...
STOPWORDS_UK = {
    ...
    # Payment context stopwords
    'оплата', 'платіж', 'користь', 'послуги', 'товари', 'роботи', 'поставка', 'договір', 'контракт', 'рахунок', 'інвойс', 'підставі', 'згідно', 'призначення', 'платежу'
}
