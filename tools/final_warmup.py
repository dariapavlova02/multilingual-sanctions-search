#!/usr/bin/env python3
"""
Final warmup script for AI normalization service.

This script tests the core functionality with proper error handling.
"""
...
class FinalWarmupService:
    """Final service for warming up the normalization service."""
    ...
    def run_warmup(self, n: int = 200) -> None:
        ...
        logger.info(f"Starting final warmup with {n} requests...")
...
def main():
    """Main function."""
    parser = argparse.ArgumentParser(description="Final warmup for AI normalization service")
    ...
    warmup_service = FinalWarmupService()
    warmup_service.run_warmup(args.n)
    
    logger.info("✓ Final warmup completed successfully!")
