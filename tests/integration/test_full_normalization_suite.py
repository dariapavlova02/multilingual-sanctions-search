...
ukrainian_test_cases = [
    ...
    ("Для Петруся Іванова, за ремонт", "Петро Іванова"),
    ("Переказ від Вовчика Зеленського В. О.", "Володимир Зеленського"),
    ("Подарунок для Дашеньки Квіткової", "Дарія Квіткова"),
    ("Від Сашка Положинського за квитки", "Олександр Положинського"),
    ("Для Жені Галича з групи O.Torvald", "Євген Галича"),
...
russian_test_cases = [
    ...
    ("Перевод от Саши Пушкина Александровича", "Александр Пушкинин Александрович"),
    ("Оплата для Володи Высоцкого", "Владимир Высоцкого"),
    ("Платёж от Димы Медведева", "Дмитрий Медведев"),
    ("Для Аллы Борисовны Пугачевой", "Алла Борисовн Пугачева"),

    # --- Падежи и склонения ---
    ("Благодарность Петру Чайковскому", "Петр Чайковском"),
    ("Встреча с Анной Ахматовой", "Анна Ахматова"),
    ("Перевод средств Ивану Бунину", "Иван Бунин"),

    # --- Инициалы ---
    ("Отправлено для Есенина С. А.", "Есенина С. А."),
    ("Зачисление от Лермонтова М.Ю.", "Лермонтова М. Ю."),
]
